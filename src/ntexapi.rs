...
use windows_sys::Wdk::Foundation::{
    DEVICE_OBJECT, FILE_OBJECT, IRP, OBJECT_ATTRIBUTES,
};
...
use windows_sys::Win32::Foundation::{BOOLEAN, HANDLE, LUID, NTSTATUS, UNICODE_STRING};
use windows_sys::Win32::Security::{GENERIC_MAPPING, SECURITY_DESCRIPTOR};
use windows_sys::Win32::System::Diagnostics::Etw::PROFILE_SOURCE_INFO;
use windows_sys::Win32::System::Kernel::{EVENT_TYPE, TIMER_TYPE, WNF_STATE_NAME};
use windows_sys::Win32::System::SystemInformation::{FIRMWARE_TYPE, GROUP_AFFINITY};
...
use crate::ntdef::TRACEHANDLE;
use crate::ntioapi::FILE_IO_COMPLETION_INFORMATION;
use crate::ntkeapi::KTHREAD_STATE;
use crate::ntldr::RTL_PROCESS_MODULE_INFORMATION_EX;
use crate::ntlpcapi::PORT_MESSAGE;
use crate::ntpebteb::TEB;
use crate::ntrtl::RTL_FEATURE_CONFIGURATION;
...
pub const USER_SHARED_DATA: *const KUSER_SHARED_DATA =
    ptr::from_ref(&0x7ffe0000).cast::<KUSER_SHARED_DATA>();
...
extern "system" {
    pub fn NtSetTimer(
        ...
        TimerContext: *mut core::ffi::c_void,
        ResumeTimer: BOOLEAN,
        Period: i32,
...
extern "system" {
    pub fn NtSetTimerEx(
        ...
        TimerSetInformation: *mut core::ffi::c_void,
...
#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn NtUmsThreadYield(SchedulerParam: *mut core::ffi::c_void) -> NTSTATUS;
}
...
pub struct WORKER_FACTORY_BASIC_INFORMATION {
    ...
    pub StartRoutine: *mut core::ffi::c_void,
    pub StartParameter: *mut core::ffi::c_void,
...
pub struct WORKER_FACTORY_DEFERRED_WORK {
    ...
    pub AlpcSendMessagePort: *mut core::ffi::c_void,
...
extern "system" {
    pub fn NtQueryAuxiliaryCounterFrequency(
        AuxiliaryCounterFrequency: *mut i64,
    ) -> NTSTATUS;
}
...
pub struct RTL_PROCESS_BACKTRACE_INFORMATION {
    ...
    pub Index: u16,
    pub Depth: u16,
    pub BackTrace: [*mut core::ffi::c_void; 32],
}
...
pub struct SYSTEM_GDI_DRIVER_INFORMATION {
    pub DriverName: UNICODE_STRING,
    pub ImageAddress: *mut core::ffi::c_void,
...
pub struct SYSTEM_BIGPOOL_ENTRY_1 {
    pub VirtualAddress: UnionField<*mut core::ffi::c_void>,
...
impl SYSTEM_BIGPOOL_ENTRY_1 {
    ...
    pub fn NonPaged(&self) -> usize {
        unsafe { core::mem::transmute(self._bitfield_1.as_ref().get(0usize, 1u8)) }
    }
...
pub struct SYSTEM_POOL_ENTRY_1 {
    pub Tag: UnionField<[u8; 4]>,
    pub TagUlong: UnionField<u32>,
    pub ProcessChargedQuota: UnionField<*mut core::ffi::c_void>,
    pub union_field: u64,
}
...
#[repr(C)]
pub struct SYSTEM_BOOT_ENVIRONMENT_INFORMATION_1_1_ARGS {
...
impl SYSTEM_BOOT_ENVIRONMENT_INFORMATION_1_1 {
    ...
    pub fn new_bitfield_1(
        args: SYSTEM_BOOT_ENVIRONMENT_INFORMATION_1_1_ARGS,
    ) -> BitfieldUnit<[u8; 2]> {
        let mut bitfield_unit: BitfieldUnit<[u8; 2]> = Default::default();
        bitfield_unit.set(0usize, 1u8, args.DbgMenuOsSelection);
        bitfield_unit.set(1usize, 1u8, args.DbgHiberBoot);
        bitfield_unit.set(2usize, 1u8, args.DbgSoftBoot);
        bitfield_unit.set(3usize, 1u8, args.DbgMeasuredLaunch);
        bitfield_unit.set(4usize, 1u8, args.DbgMeasuredLaunchCapable);
        bitfield_unit.set(5usize, 1u8, args.DbgSystemHiveReplace);
        bitfield_unit.set(6usize, 1u8, args.DbgMeasuredLaunchSmmProtections);
        bitfield_unit.set(7usize, 7u8, args.DbgMeasuredLaunchSmmLevel);
        bitfield_unit
    }
}
...
pub struct SM_STORE_CACHE_BACKED_PARAMS {
    ...
    pub EtaContext: *mut core::ffi::c_void,
...
pub struct SYSTEM_ENTROPY_TIMING_INFORMATION {
    pub EntropyRoutine: core::option::Option<
        unsafe extern "system" fn(arg1: *mut core::ffi::c_void, arg2: u32),
    >,
    pub InitializationRoutine: core::option::Option<
        unsafe extern "system" fn(
...
pub struct SYSTEM_PLATFORM_BINARY_INFORMATION {
    ...
    pub HandoffBuffer: *mut core::ffi::c_void,
    pub CommandLineBuffer: *mut core::ffi::c_void,
...
pub struct SYSTEM_POLICY_INFORMATION {
    pub InputData: *mut core::ffi::c_void,
    pub OutputData: *mut core::ffi::c_void,
...
impl SYSTEM_ISOLATED_USER_MODE_INFORMATION {
    ...
    pub fn SpareFlags(&self) -> BOOLEAN {
        self._bitfield_1.get(6usize, 2u8) as BOOLEAN
    }
    ...
    pub fn TrustletRunning(&self) -> BOOLEAN {
        self._bitfield_1.get(8usize, 1u8) as BOOLEAN
    }
    ...
    pub fn HvciDisableAllowed(&self) -> BOOLEAN {
        self._bitfield_1.get(9usize, 1u8) as BOOLEAN
    }
    ...
    pub fn SpareFlags2(&self) -> BOOLEAN {
        self._bitfield_1.get(10usize, 6u8) as BOOLEAN
    }
    ...
    pub fn new_bitfield_1(
        ...
        bitfield_unit.set(0usize, 1u8, {
            let SecureKernelRunning: u8 =
                unsafe { core::mem::transmute(SecureKernelRunning) };
        ...
        bitfield_unit.set(4usize, 1u8, {
            let FirmwarePageProtection: u8 =
                unsafe { core::mem::transmute(FirmwarePageProtection) };

            FirmwarePageProtection as u64
        });

        bitfield_unit.set(5usize, 1u8, {
            let EncryptionKeyAvailable: u8 =
                unsafe { core::mem::transmute(EncryptionKeyAvailable) };
        ...
        bitfield_unit.set(9usize, 1u8, {
            let HvciDisableAllowed: u8 =
                unsafe { core::mem::transmute(HvciDisableAllowed) };
...
pub struct SYSTEM_SINGLE_MODULE_INFORMATION {
    pub TargetModuleAddress: *mut core::ffi::c_void,
...
pub struct SYSTEM_HYPERVISOR_SHARED_PAGE_INFORMATION {
    pub HypervisorSharedUserVa: *mut core::ffi::c_void,
}
...
pub struct SYSTEM_XFG_FAILURE_INFORMATION {
    pub ReturnAddress: *mut core::ffi::c_void,
