...
use windows_sys::Wdk::Storage::FileSystem::{
    FILE_BASIC_INFORMATION, FILE_NETWORK_OPEN_INFORMATION,
};
...
impl FILE_INTERNAL_INFORMATION_1_1 {
    ...
    pub fn MftRecordIndex(&self) -> i64 {
        unsafe { core::mem::transmute(self._bitfield_1.get(0usize, 48u8)) }
    }
    ...
    pub fn SequenceNumber(&self) -> i64 {
        unsafe { core::mem::transmute(self._bitfield_1.get(48usize, 16u8)) }
    }
