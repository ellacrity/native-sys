...
use windows_sys::Win32::Foundation::{BOOLEAN, HANDLE, NTSTATUS, PSID, UNICODE_STRING};
use windows_sys::Win32::Security::{SECURITY_DESCRIPTOR, SECURITY_QUALITY_OF_SERVICE};
...
#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn NtReplyPort(PortHandle: HANDLE, ReplyMessage: *mut PORT_MESSAGE)
        -> NTSTATUS;
}
...
pub struct ALPC_CONTEXT_ATTR {
    ...
    pub MessageContext: *mut core::ffi::c_void,
    pub Sequence: u32,
    pub MessageId: u32,
    pub CallbackId: u32,
}
...
extern "system" {
    pub fn AlpcRegisterCompletionListWorkerThread(
        CompletionList: *mut core::ffi::c_void,
    ) -> BOOLEAN;
}
