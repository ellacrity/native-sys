...
use windows_sys::Wdk::System::SystemServices::SECTION_INHERIT;
use windows_sys::Win32::Foundation::{BOOLEAN, HANDLE, NTSTATUS, UNICODE_STRING};
use windows_sys::Win32::System::Memory::{
    CFG_CALL_TARGET_INFO, MEM_EXTENDED_PARAMETER,
};
...
pub struct SECTION_IMAGE_INFORMATION {
    pub TransferAddress: *mut core::ffi::c_void,
    pub ZeroBits: u32,
...
pub struct CFG_CALL_TARGET_LIST_INFORMATION {
    ...
    pub Section: *mut core::ffi::c_void,
    pub FileOffset: u64,
}
...
#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn NtExtendSection(SectionHandle: HANDLE, NewSectionSize: *mut i64)
        -> NTSTATUS;
}
