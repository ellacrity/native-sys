...
pub struct PREFETCHER_INFORMATION {
    ...
    pub PrefetcherInformation: *mut core::ffi::c_void,
...
pub struct PF_PRIVSOURCE_INFO {
    ...
    pub EProcess: *mut core::ffi::c_void,
...
pub struct PF_VIRTUAL_QUERY {
    ...
    pub QueryBuffer: *mut core::ffi::c_void,
...
pub struct SUPERFETCH_INFORMATION {
    ...
    pub SuperfetchInformation: *mut core::ffi::c_void,
