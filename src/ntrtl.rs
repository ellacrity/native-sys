...
use windows_sys::{
    ...
    Wdk::{
        ...
        System::SystemServices::{
            KSYSTEM_TIME, RTL_BITMAP, RTL_QUERY_REGISTRY_TABLE, TIME_FIELDS,
        },
    },
    Win32::{
        ...
        Security::{
            ...
            CLAIM_SECURITY_ATTRIBUTES_INFORMATION, GENERIC_MAPPING,
            LUID_AND_ATTRIBUTES, SECURITY_DESCRIPTOR, SECURITY_DESCRIPTOR_CONTROL,
        ...
        System::{
            ...
            Diagnostics::Debug::{
                ...
                PGET_RUNTIME_FUNCTION_CALLBACK, PVECTORED_EXCEPTION_HANDLER,
                WOW64_CONTEXT, XSAVE_AREA_HEADER,
            },
            Kernel::{
                LIST_ENTRY, PROCESSOR_NUMBER, RTL_BALANCED_NODE, STRING, WNF_STATE_NAME,
            },
            ...
            Threading::{
                ...
                CRITICAL_SECTION_DEBUG, LPTHREAD_START_ROUTINE, PFLS_CALLBACK_FUNCTION,
...
use crate::ntdef::WAITORTIMERCALLBACKFUNC;
use crate::ntexapi::{RTL_PROCESS_BACKTRACES, RTL_PROCESS_LOCKS, WNF_TYPE_ID};
use crate::ntldr::{RTL_PROCESS_MODULES, RTL_PROCESS_MODULE_INFORMATION_EX};
use crate::ntmmapi::SECTION_IMAGE_INFORMATION;
use crate::ntobapi::OBJECT_BOUNDARY_DESCRIPTOR;
use crate::ntpebteb::{PEB, TEB, TEB_ACTIVE_FRAME};
use crate::ntpsapi::{
    INITIAL_TEB, PPS_APC_ROUTINE, PS_PROTECTION, PUSER_THREAD_START_ROUTINE,
    THREAD_STATE_CHANGE_TYPE,
};
use crate::ntsxs::{
    ACTIVATION_CONTEXT, ACTIVATION_CONTEXT_DATA, PACTIVATION_CONTEXT_NOTIFY_ROUTINE,
};
use crate::winntdef::MESSAGE_RESOURCE_ENTRY;
...
pub const RTL_ACTIVATE_ACTIVATION_CONTEXT_EX_FLAG_RELEASE_ON_STACK_DEALLOCATION: u32 =
    1;
...
pub const RTL_QUERY_INFORMATION_ACTIVATION_CONTEXT_FLAG_ACTIVATION_CONTEXT_IS_MODULE:
    u32 = 2;
...
pub const INVALID_ACTIVATION_CONTEXT: HANDLE = -1;
pub const ACTCTX_PROCESS_DEFAULT: HANDLE = 0;
pub const ACTCTX_EMPTY: HANDLE = -3;
pub const ACTCTX_SYSTEM_DEFAULT: HANDLE = -4;
...
pub const RTL_WAITER_DEREGISTER_WAIT_FOR_COMPLETION: HANDLE = -1;
pub const RTL_TIMER_DELETE_WAIT_FOR_COMPLETION: HANDLE = -1;
...
pub const RtlDosPathSeperatorsString: UNICODE_STRING =
    UNICODE_STRING { Length: 2, MaximumLength: 2, Buffer: w!("\\/").cast_mut() };
pub const RtlAlternateDosPathSeperatorString: UNICODE_STRING =
    UNICODE_STRING { Length: 1, MaximumLength: 1, Buffer: w!("/").cast_mut() };
pub const RtlNtPathSeperatorString: UNICODE_STRING =
    UNICODE_STRING { Length: 1, MaximumLength: 1, Buffer: w!("\\").cast_mut() };
pub const RtlDosDevicesPrefix: UNICODE_STRING =
    UNICODE_STRING { Length: 4, MaximumLength: 4, Buffer: w!("\\??\\").cast_mut() };
pub const RtlDosDevicesUncPrefix: UNICODE_STRING = UNICODE_STRING {
    Length: 8,
    MaximumLength: 8,
    Buffer: w!("\\??\\UNC\\").cast_mut(),
};
pub const RtlSlashSlashDot: UNICODE_STRING =
    UNICODE_STRING { Length: 4, MaximumLength: 4, Buffer: w!("\\\\.\\").cast_mut() };
pub const RtlNullString: UNICODE_STRING =
    UNICODE_STRING { Length: 0, MaximumLength: 0, Buffer: w!("").cast_mut() };
pub const RtlWin32NtRootSlash: UNICODE_STRING =
    UNICODE_STRING { Length: 4, MaximumLength: 4, Buffer: w!("\\\\?\\").cast_mut() };
pub const RtlWin32NtRoot: UNICODE_STRING =
    UNICODE_STRING { Length: 3, MaximumLength: 4, Buffer: w!("\\\\?").cast_mut() };
pub const RtlWin32NtUncRoot: UNICODE_STRING =
    UNICODE_STRING { Length: 7, MaximumLength: 7, Buffer: w!("\\\\?\\UNC").cast_mut() };
pub const RtlWin32NtUncRootSlash: UNICODE_STRING = UNICODE_STRING {
    Length: 8,
    MaximumLength: 8,
    Buffer: w!("\\\\?\\UNC\\").cast_mut(),
};
pub const RtlDefaultExtension: UNICODE_STRING =
    UNICODE_STRING { Length: 4, MaximumLength: 4, Buffer: w!(".DLL").cast_mut() };
...
#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn RtlDeleteCriticalSection(CriticalSection: *mut CRITICAL_SECTION)
        -> NTSTATUS;
}
...
extern "system" {
    pub fn RtlWaitOnAddress(
        ...
        CompareAddress: *mut core::ffi::c_void,
        AddressSize: usize,
        Timeout: *mut i64,
    ) -> NTSTATUS;
}
...
#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn RtlWakeAddressAll(Address: *mut core::ffi::c_void);
}

#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn RtlWakeAddressSingle(Address: *mut core::ffi::c_void);
}
...
#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn RtlCultureNameToLCID(String: *mut UNICODE_STRING, Lcid: *mut u32)
        -> BOOLEAN;
}
...
#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn RtlFreeToPeb(Block: *mut core::ffi::c_void, Size: u32) -> NTSTATUS;
}
...
pub struct RTL_USER_PROCESS_PARAMETERS {
    ...
    pub PackageDependencyData: *mut core::ffi::c_void,
...
extern "system" {
    pub fn RtlCreateProcessReflection(
        ...
        StartContext: *mut core::ffi::c_void,
        EventHandle: HANDLE,
...
#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn RtlFreeUserStack(AllocationBase: *mut core::ffi::c_void) -> NTSTATUS;
}
...
extern "system" {
    pub fn RtlInitializeContext(
        ...
        Context: *mut CONTEXT,
        Parameter: *mut core::ffi::c_void,
        InitialPc: *mut core::ffi::c_void,
        InitialSp: *mut core::ffi::c_void,
    ) -> u64;
}
...
#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn RtlRemoveVectoredExceptionHandler(Handle: *mut core::ffi::c_void) -> u32;
}
...
#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn RtlRemoveVectoredContinueHandler(Handle: *mut core::ffi::c_void) -> u32;
}

pub type PRTLP_UNHANDLED_EXCEPTION_FILTER = core::option::Option<
    unsafe extern "system" fn(ExceptionInfo: *mut EXCEPTION_POINTERS) -> u32,
>;
...
extern "system" {
    pub fn RtlQueryInformationActivationContext(
        ...
        ActivationContextInformation: *mut core::ffi::c_void,
...
extern "system" {
    pub fn RtlImageNtHeader(
        BaseOfImage: *mut core::ffi::c_void,
...
#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn RtlDestroyEnvironment(Environment: *mut core::ffi::c_void) -> NTSTATUS;
}
...
extern "system" {
    pub fn RtlSetCurrentEnvironment(
        Environment: *mut core::ffi::c_void,
        PreviousEnvironment: *mut *mut core::ffi::c_void,
    ) -> NTSTATUS;
}
...
#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn RtlGetImageFileMachines(
        FileName: PCWSTR,
        FileMachines: *mut u16,
    ) -> NTSTATUS;
}
...
pub struct RTL_HEAP_ENTRY_1_2 {
    ...
    pub FirstBlock: *mut core::ffi::c_void,
}
...
extern "system" {
    pub fn RtlSizeHeap(
        HeapHandle: *mut core::ffi::c_void,
        Flags: u32,
...
#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn RtlZeroHeap(HeapHandle: *mut core::ffi::c_void, Flags: u32) -> NTSTATUS;
}

#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn RtlProtectHeap(HeapHandle: *mut core::ffi::c_void, MakeReadOnly: BOOLEAN);
}

#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn RtlLockHeap(HeapHandle: *mut core::ffi::c_void) -> BOOLEAN;
}

#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn RtlUnlockHeap(HeapHandle: *mut core::ffi::c_void) -> BOOLEAN;
}
...
extern "system" {
    pub fn RtlGetUserInfoHeap(
        ...
        Flags: u32,
        BaseAddress: *mut core::ffi::c_void,
        UserValue: *mut *mut core::ffi::c_void,
        UserFlags: *mut u32,
    ) -> BOOLEAN;
}
...
#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn RtlCompactHeap(HeapHandle: *mut core::ffi::c_void, Flags: u32) -> usize;
}
...
extern "system" {
    pub fn RtlGetProcessHeaps(
        NumberOfHeaps: u32,
        ProcessHeaps: *mut *mut core::ffi::c_void,
    ) -> u32;
}

pub type PRTL_ENUM_HEAPS_ROUTINE = core::option::Option<
...
pub struct RTL_HEAP_WALK_ENTRY {
    pub DataAddress: *mut core::ffi::c_void,
    pub DataSize: usize,
...
pub struct RTL_HEAP_WALK_ENTRY_1_2 {
    ...
    pub FirstEntry: *mut core::ffi::c_void,
    pub LastEntry: *mut core::ffi::c_void,
}
...
pub struct RTLP_HEAP_STACK_TRACE_SERIALIZATION_STACKFRAME {
    pub StackFrame: [*mut core::ffi::c_void; 8],
}
...
pub struct RTL_HEAP_STACK_QUERY {
    ...
    pub SerializationContext: *mut core::ffi::c_void,
    pub QueryLevel: u8,
    pub Flags: u8,
}
...
pub type PRTL_HEAP_DEBUGGING_INTERCEPTOR_ROUTINE = core::option::Option<
    unsafe extern "system" fn(
        ...
        StackTrace: *mut *mut core::ffi::c_void,
    ) -> NTSTATUS,
>;
...
extern "system" {
    pub fn RtlQueryHeapInformation(
        ...
        HeapInformation: *mut core::ffi::c_void,
...
extern "system" {
    pub fn RtlCreateMemoryZone(
        MemoryZone: *mut *mut core::ffi::c_void,
        InitialSize: usize,
        Flags: u32,
    ) -> NTSTATUS;
}
...
#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn RtlDestroyMemoryZone(MemoryZone: *mut core::ffi::c_void) -> NTSTATUS;
}

#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn RtlAllocateMemoryZone(
        MemoryZone: *mut core::ffi::c_void,
        BlockSize: usize,
        Block: *mut *mut core::ffi::c_void,
    ) -> NTSTATUS;
}
...
#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn RtlResetMemoryZone(MemoryZone: *mut core::ffi::c_void) -> NTSTATUS;
}

#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn RtlLockMemoryZone(MemoryZone: *mut core::ffi::c_void) -> NTSTATUS;
}

#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn RtlUnlockMemoryZone(MemoryZone: *mut core::ffi::c_void) -> NTSTATUS;
}

#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn RtlCreateMemoryBlockLookaside(
        MemoryBlockLookaside: *mut *mut core::ffi::c_void,
        Flags: u32,
        InitialSize: u32,
...
extern "system" {
    pub fn RtlDestroyMemoryBlockLookaside(
        MemoryBlockLookaside: *mut core::ffi::c_void,
    ) -> NTSTATUS;
}
...
pub struct RTL_DEBUG_INFORMATION {
    ...
    pub ViewBaseClient: *mut core::ffi::c_void,
    pub ViewBaseTarget: *mut core::ffi::c_void,
    ...
    pub Heaps: *mut core::ffi::c_void,
    pub Locks: *mut RTL_PROCESS_LOCKS,
    pub SpecificHeap: *mut core::ffi::c_void,
...
pub struct PARSE_MESSAGE_CONTEXT {
    ...
    pub lpvArgStart: *mut core::ffi::c_void,
}
...
extern "system" {
    pub fn RtlCreateAtomTable(
        NumberOfBuckets: u32,
        AtomTableHandle: *mut *mut core::ffi::c_void,
    ) -> NTSTATUS;
}

#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn RtlDestroyAtomTable(AtomTableHandle: *mut core::ffi::c_void) -> NTSTATUS;
}

#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn RtlEmptyAtomTable(
        AtomTableHandle: *mut core::ffi::c_void,
...
#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn RtlSidDominates(Sid1: PSID, Sid2: PSID, Dominates: *mut BOOLEAN)
        -> NTSTATUS;
}
...
extern "system" {
    pub fn RtlQueryInformationAcl(
        Acl: *mut ACL,
        AclInformation: *mut core::ffi::c_void,
...
extern "system" {
    pub fn RtlFirstFreeAce(
        Acl: *mut ACL,
        FirstFree: *mut *mut core::ffi::c_void,
    ) -> BOOLEAN;
}
...
extern "system" {
    pub fn RtlDeleteSecurityObject(
        ObjectDescriptor: *mut *mut SECURITY_DESCRIPTOR,
    ) -> NTSTATUS;
}
...
extern "system" {
    pub fn RtlAcquirePrivilege(
        ...
        NumPriv: u32,
        Flags: u32,
        ReturnedState: *mut *mut core::ffi::c_void,
    ) -> NTSTATUS;
}

#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn RtlReleasePrivilege(StatePointer: *mut core::ffi::c_void);
}
...
#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn RtlDeregisterWaitEx(WaitHandle: HANDLE, CompletionEvent: HANDLE)
        -> NTSTATUS;
}
...
pub type PRTL_EXIT_POOL_THREAD =
    core::option::Option<unsafe extern "system" fn(arg1: NTSTATUS) -> NTSTATUS>;
...
extern "system" {
    pub fn RtlEnableThreadProfiling(
        ...
        PerformanceDataHandle: *mut *mut core::ffi::c_void,
    ) -> NTSTATUS;
}
...
extern "system" {
    pub fn RtlDisableThreadProfiling(
        PerformanceDataHandle: *mut core::ffi::c_void,
    ) -> NTSTATUS;
}
...
extern "system" {
    pub fn RtlGetNativeSystemInformation(
        ...
        NativeSystemInformation: *mut core::ffi::c_void,
...
extern "system" {
    pub fn RtlWow64EnableFsRedirectionEx(
        Wow64FsEnableRedirection: *mut core::ffi::c_void,
        OldFsRedirectionLevel: *mut *mut core::ffi::c_void,
    ) -> NTSTATUS;
}
...
#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn RtlEncodePointer(Ptr: *mut core::ffi::c_void) -> *mut core::ffi::c_void;
}

#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn RtlDecodePointer(Ptr: *mut core::ffi::c_void) -> *mut core::ffi::c_void;
}
...
extern "system" {
    pub fn RtlEncodeRemotePointer(
        ...
        EncodedPointer: *mut *mut core::ffi::c_void,
    ) -> NTSTATUS;
}
...
extern "system" {
    pub fn RtlDecodeRemotePointer(
        ProcessHandle: HANDLE,
        Pointer: *mut core::ffi::c_void,
        DecodedPointer: *mut *mut core::ffi::c_void,
    ) -> NTSTATUS;
}
...
#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn RtlLockModuleSection(Address: *mut core::ffi::c_void) -> NTSTATUS;
}

#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn RtlUnlockModuleSection(Address: *mut core::ffi::c_void) -> NTSTATUS;
}
...
extern "system" {
    pub fn RtlGetUnloadEventTraceEx(
        ...
        EventTrace: *mut *mut core::ffi::c_void,
    );
}
...
#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn RtlCheckSandboxedToken(
        TokenHandle: HANDLE,
        IsSandboxed: *mut BOOLEAN,
    ) -> NTSTATUS;
}
...
#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn RtlQueryTokenHostIdAsUlong64(
        TokenHandle: HANDLE,
        HostId: *mut u64,
    ) -> NTSTATUS;
}
...
#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn RtlFlsGetValue(
        FlsIndex: u32,
        FlsData: *mut *mut core::ffi::c_void,
    ) -> NTSTATUS;
}

#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn RtlFlsSetValue(FlsIndex: u32, FlsData: *mut core::ffi::c_void) -> NTSTATUS;
}
...
impl RTL_BSD_DATA_POWER_TRANSITION_1 {
    ...
    pub fn new_bitfield_1(
        ...
        bitfield_unit.set(2usize, 1u8, {
            let UserShutdownInProgress: u8 =
                unsafe { core::mem::transmute(UserShutdownInProgress) };
...
#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn RtlCheckBootStatusIntegrity(
        FileHandle: HANDLE,
...
pub type PRTL_SECURE_MEMORY_CACHE_CALLBACK = core::option::Option<
    unsafe extern "system" fn(arg1: *mut core::ffi::c_void, arg2: usize) -> NTSTATUS,
>;
...
extern "system" {
    pub fn RtlFlushSecureMemoryCache(
        MemoryCache: *mut core::ffi::c_void,
        MemoryLength: usize,
    ) -> BOOLEAN;
}
...
#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn RtlNotifyFeatureUsage(
        FeatureUsageReport: *mut RTL_FEATURE_USAGE_REPORT,
    ) -> NTSTATUS;
}
...
pub type PRTL_FEATURE_CONFIGURATION_CHANGE_NOTIFICATION =
    core::option::Option<unsafe extern "system" fn(arg1: *mut core::ffi::c_void)>;
...
extern "system" {
    pub fn RtlSubscribeWnfStateChangeNotification(
        SubscriptionHandle: *mut *mut core::ffi::c_void,
        StateName: WNF_STATE_NAME,
        ChangeStamp: u32,
        Callback: PWNF_USER_CALLBACK,
        CallbackContext: *mut core::ffi::c_void,
