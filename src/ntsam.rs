...
use windows_sys::Win32::Foundation::{
    BOOL, BOOLEAN, HANDLE, NTSTATUS, PSID, UNICODE_STRING,
};
use windows_sys::Win32::Security::Authentication::Identity::{
    DOMAIN_PASSWORD_INFORMATION, LOGON_HOURS, USER_ALL_INFORMATION,
};
use windows_sys::Win32::Security::{SECURITY_DESCRIPTOR, SID_NAME_USE};
use windows_sys::Win32::System::Kernel::STRING;
use windows_sys::Win32::System::PasswordManagement::{
    CYPHER_BLOCK, ENCRYPTED_LM_OWF_PASSWORD,
};
...
extern "system" {
    pub fn SamFreeMemory(Buffer: *mut core::ffi::c_void) -> NTSTATUS;
}

#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn SamCloseHandle(SamHandle: *mut core::ffi::c_void) -> NTSTATUS;
}

#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn SamSetSecurityObject(
        ObjectHandle: *mut core::ffi::c_void,
...
extern "system" {
    pub fn SamConnect(
        ...
        ServerHandle: *mut *mut core::ffi::c_void,
        DesiredAccess: u32,
...
#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn SamShutdownSamServer(ServerHandle: *mut core::ffi::c_void) -> NTSTATUS;
}
...
extern "system" {
    pub fn SamLookupDomainInSamServer(
        ServerHandle: *mut core::ffi::c_void,
...
extern "system" {
    pub fn SamOpenDomain(
        ...
        DesiredAccess: u32,
        DomainId: PSID,
        DomainHandle: *mut *mut core::ffi::c_void,
    ) -> NTSTATUS;
}
...
extern "system" {
    pub fn SamQueryInformationDomain(
        DomainHandle: *mut core::ffi::c_void,
...
extern "system" {
    pub fn SamSetInformationDomain(
        DomainHandle: *mut core::ffi::c_void,
        DomainInformationClass: DOMAIN_INFORMATION_CLASS,
        DomainInformation: *mut core::ffi::c_void,
    ) -> NTSTATUS;
}
...
extern "system" {
    pub fn SamCreateGroupInDomain(
        ...
        DesiredAccess: u32,
        GroupHandle: *mut *mut core::ffi::c_void,
        RelativeId: *mut u32,
    ) -> NTSTATUS;
}
...
#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn SamDeleteGroup(GroupHandle: *mut core::ffi::c_void) -> NTSTATUS;
}

#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn SamQueryInformationGroup(
        GroupHandle: *mut core::ffi::c_void,
...
#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn SamRemoveMemberFromGroup(
        GroupHandle: *mut core::ffi::c_void,
        MemberId: u32,
    ) -> NTSTATUS;
}
...
extern "system" {
    pub fn SamCreateAliasInDomain(
        ...
        AccountName: *mut UNICODE_STRING,
        DesiredAccess: u32,
        AliasHandle: *mut *mut core::ffi::c_void,
        RelativeId: *mut u32,
    ) -> NTSTATUS;
}
...
#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn SamDeleteAlias(AliasHandle: *mut core::ffi::c_void) -> NTSTATUS;
}

#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn SamQueryInformationAlias(
        AliasHandle: *mut core::ffi::c_void,
...
#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn SamRemoveMemberFromAlias(
        AliasHandle: *mut core::ffi::c_void,
        MemberId: PSID,
    ) -> NTSTATUS;
}
...
#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn SamDeleteUser(UserHandle: *mut core::ffi::c_void) -> NTSTATUS;
}
...
#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn SamGetCompatibilityMode(
        ObjectHandle: *mut core::ffi::c_void,
        Mode: *mut u32,
    ) -> NTSTATUS;
}
