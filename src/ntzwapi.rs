...
use windows_sys::Wdk::Foundation::{OBJECT_ATTRIBUTES, OBJECT_INFORMATION_CLASS};
use windows_sys::Wdk::Storage::FileSystem::FILE_BASIC_INFORMATION;
use windows_sys::Wdk::System::Registry::KEY_VALUE_ENTRY;
use windows_sys::Wdk::System::SystemServices::{
    DIRECTORY_NOTIFY_INFORMATION_CLASS, IO_SESSION_EVENT, IO_SESSION_STATE,
    KPROFILE_SOURCE, PARTITION_INFORMATION_CLASS,
};
use windows_sys::Wdk::System::Threading::{PROCESSINFOCLASS, THREADINFOCLASS};
use windows_sys::Win32::Foundation::{
    BOOLEAN, HANDLE, LUID, NTSTATUS, PSID, UNICODE_STRING,
};
...
use windows_sys::Win32::System::JobObjects::{JOBOBJECTINFOCLASS, JOB_SET_ARRAY};
use windows_sys::Win32::System::Kernel::{PROCESSOR_NUMBER, WAIT_TYPE, WNF_STATE_NAME};
use windows_sys::Win32::System::Memory::MEM_EXTENDED_PARAMETER;
...
use crate::ntdbg::{DBGUI_WAIT_STATE_CHANGE, DEBUGOBJECTINFOCLASS};
use crate::ntdef::PENCLAVE_ROUTINE;
use crate::ntexapi::{
    ATOM_INFORMATION_CLASS, BOOT_ENTRY, BOOT_OPTIONS, EFI_DRIVER_ENTRY,
    EVENT_INFORMATION_CLASS, FILE_PATH, FILTER_BOOT_OPTION_OPERATION,
    MUTANT_INFORMATION_CLASS, SEMAPHORE_INFORMATION_CLASS, SHUTDOWN_ACTION,
    SYSDBG_COMMAND, SYSTEM_INFORMATION_CLASS, T2_SET_PARAMETERS,
    TIMER_INFORMATION_CLASS, WNF_DATA_SCOPE, WNF_DELIVERY_DESCRIPTOR,
    WNF_STATE_NAME_INFORMATION, WNF_STATE_NAME_LIFETIME, WNF_TYPE_ID,
    WORKERFACTORYINFOCLASS, WORKER_FACTORY_DEFERRED_WORK,
};
use crate::ntioapi::{FILE_IO_COMPLETION_INFORMATION, IO_COMPLETION_INFORMATION_CLASS};
use crate::ntlpcapi::{
    ...
    ALPC_SECURITY_ATTR, PORT_INFORMATION_CLASS, PORT_MESSAGE, PORT_VIEW,
    REMOTE_PORT_VIEW,
};
use crate::ntmisc::{TRACE_CONTROL_INFORMATION_CLASS, VDMSERVICECLASS};
use crate::ntmmapi::SECTION_INFORMATION_CLASS;
use crate::ntobapi::{OBJECT_BOUNDARY_DESCRIPTOR, SYMBOLIC_LINK_INFO_CLASS};
use crate::ntpnpapi::{PLUGPLAY_CONTROL_CLASS, PLUGPLAY_EVENT_BLOCK};
use crate::ntpsapi::{
...
use crate::ntregapi::CM_EXTENDED_PARAMETER;
use crate::ntseapi::TOKEN_SECURITY_ATTRIBUTES_INFORMATION;

#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn ZwAcceptConnectPort(
        PortHandle: *mut HANDLE,
        PortContext: *mut core::ffi::c_void,
...
extern "system" {
    pub fn ZwAlpcQueryInformationMessage(
        ...
        MessageInformation: *mut core::ffi::c_void,
        Length: u32,
        ReturnLength: *mut u32,
    ) -> NTSTATUS;
}
...
extern "system" {
    pub fn ZwAreMappedFilesTheSame(
        File1MappedAsAnImage: *mut core::ffi::c_void,
        File2MappedAsFile: *mut core::ffi::c_void,
    ) -> NTSTATUS;
}
...
extern "system" {
    pub fn ZwCompareSigningLevels(
        FirstSigningLevel: u8,
        SecondSigningLevel: u8,
    ) -> NTSTATUS;
}
...
extern "system" {
    pub fn ZwConnectPort(
        ...
        ConnectionInformation: *mut core::ffi::c_void,
...
extern "system" {
    pub fn ZwCreateEnclave(
        ...
        EnclaveType: u32,
        EnclaveInformation: *mut core::ffi::c_void,
...
extern "system" {
    pub fn ZwCreateProfile(
        ...
        Process: HANDLE,
        ProfileBase: *mut core::ffi::c_void,
        ProfileSize: usize,
        BucketSize: u32,
        Buffer: *mut u32,
        BufferSize: u32,
...
extern "system" {
    pub fn ZwCreateWorkerFactory(
        ...
        StartRoutine: *mut core::ffi::c_void,
        StartParameter: *mut core::ffi::c_void,
        MaxThreadCount: u32,
        StackReserve: usize,
        StackCommit: usize,
    ) -> NTSTATUS;
...
#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn ZwExtendSection(SectionHandle: HANDLE, NewSectionSize: *mut i64)
        -> NTSTATUS;
}
...
#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn ZwGetCurrentProcessorNumberEx(ProcessorNumber: *mut PROCESSOR_NUMBER)
        -> u32;
}
...
extern "system" {
    pub fn ZwGetNlsSectionPtr(
        SectionType: u32,
        SectionData: u32,
        ContextData: *mut core::ffi::c_void,
        SectionPointer: *mut *mut core::ffi::c_void,
        SectionSize: *mut u32,
    ) -> NTSTATUS;
}
...
extern "system" {
    pub fn ZwGetWriteWatch(
        ...
        BaseAddress: *mut core::ffi::c_void,
        RegionSize: usize,
        UserAddressArray: *mut *mut core::ffi::c_void,
...
extern "system" {
    pub fn ZwLoadEnclaveData(
        ...
        BufferSize: usize,
        Protect: u32,
        PageInformation: *mut core::ffi::c_void,
...
extern "system" {
    pub fn ZwMapUserPhysicalPagesScatter(
        VirtualAddresses: *mut *mut core::ffi::c_void,
        NumberOfPages: usize,
        UserPfnArray: *mut usize,
    ) -> NTSTATUS;
}
...
extern "system" {
    pub fn ZwQueryEvent(
        ...
        EventInformation: *mut core::ffi::c_void,
...
extern "system" {
    pub fn ZwQueryInformationAtom(
        ...
        AtomInformation: *mut core::ffi::c_void,
...
extern "system" {
    pub fn ZwQueryInformationWorkerFactory(
        ...
        WorkerFactoryInformation: *mut core::ffi::c_void,
...
extern "system" {
    pub fn ZwQueryIoCompletion(
        ...
        IoCompletionInformation: *mut core::ffi::c_void,
...
extern "system" {
    pub fn ZwQueryMutant(
        ...
        MutantInformation: *mut core::ffi::c_void,
...
extern "system" {
    pub fn ZwQuerySection(
        ...
        SectionInformation: *mut core::ffi::c_void,
...
extern "system" {
    pub fn ZwQuerySemaphore(
        ...
        SemaphoreInformation: *mut core::ffi::c_void,
...
extern "system" {
    pub fn ZwQueryTimer(
        ...
        TimerInformation: *mut core::ffi::c_void,
...
extern "system" {
    pub fn ZwRegisterProtocolAddressInformation(
        ...
        ProtocolInformation: *mut core::ffi::c_void,
        CreateOptions: u32,
    ) -> NTSTATUS;
}
...
extern "system" {
    pub fn ZwRemoveIoCompletion(
        IoCompletionHandle: HANDLE,
        KeyContext: *mut *mut core::ffi::c_void,
        ApcContext: *mut *mut core::ffi::c_void,
        IoStatusBlock: *mut IO_STATUS_BLOCK,
        Timeout: *mut i64,
    ) -> NTSTATUS;
}
...
#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn ZwReplyPort(PortHandle: HANDLE, ReplyMessage: *mut PORT_MESSAGE)
        -> NTSTATUS;
}
...
extern "system" {
    pub fn ZwReplyWaitReceivePort(
        PortHandle: HANDLE,
        PortContext: *mut *mut core::ffi::c_void,
...
extern "system" {
    pub fn ZwSetInformationSymbolicLink(
        ...
        SymbolicLinkInformation: *mut core::ffi::c_void,
...
#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn ZwUmsThreadYield(SchedulerParam: *mut core::ffi::c_void) -> NTSTATUS;
}
...
extern "system" {
    pub fn ZwVdmControl(
        ...
        ServiceData: *mut core::ffi::c_void,
    ) -> NTSTATUS;
}
