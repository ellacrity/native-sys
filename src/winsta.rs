...
use windows_sys::Win32::Foundation::{
    BOOLEAN, FILETIME, HANDLE, HWND, PSID, UNICODE_STRING,
};
...
pub const WINSTATION_CURRENT_SERVER: HANDLE = 0;
pub const WINSTATION_CURRENT_SERVER_HANDLE: HANDLE = 0;
pub const WINSTATION_CURRENT_SERVER_NAME: *mut core::ffi::c_void =
    core::ptr::null_mut();
pub const WINSTATION_CURRENT_SESSION: u32 = 4294967295;
pub const WINSTATION_ANY_SESSION: u32 = 4294967294;
pub const SERVERNAME_CURRENT: PWSTR = core::ptr::null_mut();
...
pub struct TS_PROCESS_INFORMATION_NT4 {
    pub MagicNumber: u32,
    pub LogonId: u32,
    pub ProcessSid: *mut core::ffi::c_void,
    pub Pad: u32,
}
...
extern "system" {
    pub fn WinStationFreeMemory(Buffer: *mut core::ffi::c_void) -> BOOLEAN;
}
...
#[link(name = "ntdll.dll", kind = "raw-dylib", modifiers = "+verbatim")]
extern "system" {
    pub fn WinStationShutdownSystem(
        ServerHandle: HANDLE,
        ShutdownFlags: u32,
    ) -> BOOLEAN;
}
...
extern "system" {
    pub fn WinStationQueryInformationW(
        ...
        pWinStationInformation: *mut core::ffi::c_void,
...
extern "system" {
    pub fn WinStationGetProcessSid(
        ...
        pProcessUserSid: *mut core::ffi::c_void,
        dwSidSize: *mut u32,
    ) -> BOOLEAN;
}
